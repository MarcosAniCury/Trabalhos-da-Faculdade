...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      new File("Indice.db").delete();  // apaga o arquivo anterior
      new File("dados/pessoas.hash_d.db").delete(); // apaga o arquivo anterior 
      new File("dados/pessoas.hash_c.db").delete(); // apaga o arquivo anterior 
