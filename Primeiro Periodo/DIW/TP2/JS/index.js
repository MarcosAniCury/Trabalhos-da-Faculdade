function getHTMLProduct(product) {
    ...
    <article class="product">
        <div class="div-img-product">
            <img class="img-product" src="Assets/${product.name.toLowerCase()}.jpg" alt="${product.name}">
        </div>
        <legend class="legend-product">Dixit</legend>
        <div class="div-stars">
        ...
        <div class="div-product-price">
            ...
            &nbsp;&nbsp;
            <p class="product-price-old">R$ 350,00</p>
            &nbsp;&nbsp;
