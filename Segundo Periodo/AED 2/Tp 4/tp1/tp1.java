...
class Arvore
{
    ...
    {
        raiz = new no(new Personagem(links[0]));
    ...
    {
        aux = raiz;
        if(raiz.elemento.Getsnome().compareTo(x.Getsnome()) < 0)
        {
            nodir(x);
        }
        else if(raiz.elemento.Getsnome().compareTo(x.Getsnome()) > 0)
        {
            noesq(x);
        }
    }
    ...
    {
        MyIO.print(" raiz");
        if (raiz.elemento.Getsnome().compareTo(nome) == 0)
        {
            MyIO.print(" SIM\n");
        }
        else if (raiz.elemento.Getsnome().compareTo(nome) < 0)
            verificacaodir(nome);
        else if (raiz.elemento.Getsnome().compareTo(nome) > 0)
            verificacaoesq(nome);
    }
