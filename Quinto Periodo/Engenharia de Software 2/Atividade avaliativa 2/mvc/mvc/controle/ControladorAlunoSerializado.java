...
public class ControladorAlunoSerializado 
{
    ...
    public void criaAluno(String dre, String nome, String telefone, String endereco, Date dataNasc) throws DreDuplicadoException
    {
        if(alunos.get(dre) == null) {
            alunos.put(dre, new Aluno(dre, nome, telefone, endereco, dataNasc));
        } else {
    ...
    {
        alunos.put(aluno.getDre(), aluno);
    }

    public void limparAluno(String dre)
    {
        alunos.remove(dre);
    }
}
